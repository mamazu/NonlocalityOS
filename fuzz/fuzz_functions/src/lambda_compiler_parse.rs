...
fn crash_12() {
    assert!(fuzz_function(&[
        63, 213, 209, 213, 47, 240, 119, 3, 255, 5, 5, 5, 63, 0, 64, 255, 255, 178, 255, 255, 255,
        255, 255, 255, 255, 64, 16, 64, 255, 255, 255, 255, 255, 255, 64, 16, 64, 73, 220, 201,
        255, 127, 255, 47, 28, 0, 240
    ]));
}
